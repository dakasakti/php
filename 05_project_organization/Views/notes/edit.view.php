            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="mt-5 md:col-span-2 md:mt-0">
                    <form action="/notes" method="POST">
                        ...
                        <input type="hidden" name="id" value="<?= $contents["id"] ?? $contents[0]['id'] ?>">
                            ...
                            <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                                <div>
                                    <div class="col-span-3 sm:col-span-2">
                                        ...
                                        <input type="text" name="title" id="title" value="<?= $contents["title"] ?? $contents[0]['title'] ?>" autocomplete="title" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="title">

                                        <?php if (isset($contents[1]["title"])) : ?>
                                            <p class="mt-3 text-red-500"><?= $contents[1]["title"] ?></p>
                                        <?php endif ?>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <textarea id="about" name="body" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="content"><?= $contents["body"] ?? $contents[0]['body'] ?></textarea>
                                        <?php if (isset($contents[1]["body"])) : ?>
                                            <p class="mt-3 text-red-500"><?= $contents[1]["body"] ?></p>
                                        <?php endif ?>
                                    </div>
                                </div>
